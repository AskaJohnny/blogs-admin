...
public class DateUtils {
    ...
    public static final String DATE_TIME_FULL_FORMAT = "yyyyMMddHHmmss";
    public static final String DATE_TIME_FULL_FORMAT2 = "yyyyMMddHHmmssSSS";
    ...
    public static long betweenDate(Date startDate, Date endDate, String format) {
        //设置转换的日期格式
    ...
    public static int discrepancyMonthCount() {
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM");
        Calendar bef = Calendar.getInstance();
        Calendar aft = Calendar.getInstance();
        try {
            bef.setTime(sdf.parse("2019-10"));
    ...
    public static List<String> compareDate(List<Date> dateList) {
        ...
        for (Date date : dateList) {
            dateListStr.add(DateUtils.formatDate(date, "yyyy-MM"));
        }
        return dateListStr;
    }
    ...
    public static boolean isCurrentMonth(Date destDate) {
        ...
        return StringUtils.equals(curDateStr, destDateStr);
    }
    ...
    public static String secondToTime(long second) {
        ...
        return (hours < ten ? "0" + hours : hours) + "" + (minutes < ten ? "0" + minutes : minutes) + "" + (second < ten ? "0" + second : second);
